...
public class EtudiantServiceImplTest {
    ...
    public void testAddAndAssignEtudiantToEquipeAndContract() {
        ...
        etudiantServiceImpl.addAndAssignEtudiantToEquipeAndContract(etudiant, 1,
                1);
    ...
    public void testGetEtudiantsByDepartement() {
        ...
        when(etudiantRepository.findEtudiantsByDepartement_IdDepart(1)).thenReturn(
                etudiants);
        // Appeler la méthode à tester
        List<Etudiant> result =
                etudiantServiceImpl.getEtudiantsByDepartement(1);
        // Vérifier le résultat
        assertEquals(1, result.size());
        verify(etudiantRepository,
                times(1)).findEtudiantsByDepartement_IdDepart(1);
    }
}